    ...
    <nav className="navbar" ref={navRef}>
      ...
      <div className="navbar-icons">
        ...
        <div
          ...
          role="button"
          tabIndex={0}
          onKeyPress={(e) => { if (e.key === 'Enter') toggleMenu('lang'); }}
        >
        ...
        <div
          ...
          role="button"
          tabIndex={0}
          onKeyPress={(e) => { if (e.key === 'Enter') toggleMenu('user'); }}
        >
          <img src={UserIcon} alt="User" className="icon-image" />
          {openMenu === 'user' && (
            <div className="menu-options user-menu">
              <a href="/login" onClick={() => setOpenMenu(null)}>Login</a>
              <a href="/signup" onClick={() => setOpenMenu(null)}>Sign Up</a>
              <a href="/profile" onClick={() => setOpenMenu(null)}>Profile</a>
        ...
        <div
          ...
          role="button"
          tabIndex={0}
          onKeyPress={(e) => { if (e.key === 'Enter') toggleMenu('hamburger'); }}
        >
          <img src={ListIcon} alt="Menu" className="icon-image" />
          {openMenu === 'hamburger' && (
            <div className="menu-options hamburger-menu">
              <a href="/dashboard" onClick={() => setOpenMenu(null)}>Dashboard</a>
              <a href="/settings" onClick={() => setOpenMenu(null)}>Settings</a>
              <a href="/help" onClick={() => setOpenMenu(null)}>Help</a>
            </div>
          )}
        </div>
