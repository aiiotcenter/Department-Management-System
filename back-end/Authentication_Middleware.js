...
//====================================================================================================================================
//? (.Protect) middleware to authenticate JWT in order to restrict access to certain pages (like homepage) for non-logged-in users
//===================================================================================================================================
...
function authenticateToken(req, res, next) {
    ...
    jwt.verify(token, process.env.JWT_SECRET, (error, user) => {
        if (error){
            ...
            return res.json({message: 'Invalid or expired token. Please log in again', error});
        }
        req.user = user;
...
//==================================================================================================================================
//? (.prevent) middleware to restrict access to some pages ( like login page for a user who alraedy logged in ) , prevent access
//===================================================================================================================================
...
function authRole( req, res, next){
    if(req.user.role !== "admin"){
        return res.status(403).json({message: 'Access denied. This page is accessable only by admins!'});
    }
    next();
};
